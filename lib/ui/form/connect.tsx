...
const classNames = {
  paragraph: "font-amazingSlab text-base text-center ",
};
    ...
    <CustomSection sectionId="let-connect">
      <Layout>
        ...
        <section className="w-full pt-36 lg:pt-2 ">
          <>
            <h2 className="text-primary_text font-bold font-amazingSlab lg:text-[46px] text-3xl text-center">
              Hei, Reach out us!
            </h2>
            <p className={`${classNames.paragraph} mt-3 lg:text-[20px]`}>
              Ready to elevate your Brand to new heights{" "}
            </p>
            <p className={`${classNames.paragraph} mt-3 lg:text-[20px]`}>Let&apos;s make it happen.</p>
          </>
