...
export default function Footer() {
  ...
  return (
    <div
      id="footer-section"
      className={"bg-black px-4 md:px-8 w-[100%]  mt-10 md:mt-20"}
    >
      <div className="grid grid-cols-4 gap-4 auto-rows-auto relative place-content-center ">
        ...
        <AnimatePresence mode="popLayout">
          <motion.div
            ...
            className="col-span-3 flex flex-wrap gap-4 mt-20  xl:pl-[250px] lg:pl-[150px]                                                                                                                                              0px]"
        ...
        <motion.div
          initial={{ opacity: 0 ,}}
          animate={isVisible ? { opacity: 1 } : { opacity: 0 } }
          className="pr-0 md:pr-4 xl:pr-8 overflow-x-auto"
          transition={{ duration: 2, ease: "anticipate" }}
        >
          <Image
