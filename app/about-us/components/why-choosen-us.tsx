...
export default function WhyChooseUs() {
  ...
  return (
    ...
    >
      <motion.div
        className="absolute top-[102px] -left-4 w-[400px] h-[400px]  "
        initial={initial(-100)}
        animate={
          isVisible
            ? { x: 20, opacity: 1, width: width > 800 ? 250 : 100 }
            : initial(-100)
        }
      ...
      <motion.div
        className="absolute bottom-[5rem] -right-5  w-[400px] h-[400px]  "
        initial={initial(100)}
        animate={
          isVisible
            ? {
      ...
      <div className="container mx-auto relative z-10">
        <h2
          className={`text-3xl md:mx-[3rem] lg:mx-[auto] mx-auto 
            max-w-[913px] font-amazingSlab lg:text-center xs:text-center font-bold 
        ...
        <p
          className={`mt-4 text-lg md:mx-[3rem] lg:mx-[auto] 
            ...
            mx-auto transition-opacity duration-700 delay-150 ease-out text-center ${
              isVisible
                ? "opacity-100 translate-y-0"
                : "opacity-0 translate-y-10"
            }`}
        ...
        <div className="mt-12 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 md:gap-8 justify-items-center overflow-hidden lg:px-[70px] md:px[20px]sm:px-[20px] xs:px-[20px] ">
                ...
                >
                  <div className="flex relative z-40">
                    <motion.div
                      ...
                      className="relative w-[120px] h-[120px] lg:w-[140px] lg:h-[140px] mb-4 bg-[#D6D6D6] rounded-[5px] shrink-0 z-[2] overflow-hidden"
                    >
                      <Image
                        src={feature.icon}
                        alt={feature.title}
                    ...
                    <motion.div
                      className={` md:w-[250px] w-[200px] h-[120px] lg:w-[280px] lg:h-[140px] 
                        flex items-center bg-primary_text text-left 
                        rounded-r-md rounded-b-md xs:text-[10px] md:text-[12px] p-6 z-[1] font-amazingSlab ${
                  ...
                  <motion.h3
                    className="font-bold font-amazingSlab leading-[25px] text-xl mt-4"
                    initial={{ x: 0 }}
                    animate={{ x: contentExtend.startsWith("hover") ? 0 : 0 }}
                    transition={{ duration: 0.3, ease: "easeInOut" }}
                  >
                    {feature.title}
                  </motion.h3>
