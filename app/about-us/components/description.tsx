...
export default function Description() {
  return (
    ...
    >
      ...
      >
        <Header name="Our Vision & Mission" className="p-4 pb-8 text-center text-3xl" />
        <div className="grid relative md:grid-cols-3 gap-8 items-center text-center md:text-left">
          {/* Vision Section */}
          <div className="space-y-4 ">
            <div className="flex items-center justify-center xs:pt-3 md:justify-start space-x-2  pl-[110px]">
              <h2 className="text-3xl font-bold text-primary_text text-center ">Vision</h2>
              <Image
            ...
            <h3 className="font-bold text-lg lg:text-lg md:text-sm text-center">
              Shaping the Future of Brands
            </h3>
            <p className="text-gray-300 text-lg lg:text-lg md:text-sm leading-relaxed text-center">
          ...
          {/* Mission Section */}
          <div className="space-y-4 ">
            <div className="flex items-center justify-center md:justify-end space-x-2  pr-[100px]">
              <Image
                ...
                height={70}
              />
              <h2 className="text-3xl font-bold text-primary_text text-center">Mission</h2>
            </div>
            <h3 className="font-bold xs:text-center md:text-sm text-lg lg:text-lg  text-center ">
        ...
        <div className="text-center mt-10 text-lg lg:text-lg md:text-sm">
          <h2 className="text-3xl font-bold text-primary_text">
            What We Do Best?
          </h2>
          <div
