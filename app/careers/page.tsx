  ...
  return (
    <div id="a1" className="max-w-screen-xl mx-auto">
      ...
      <motion.div
        ...
        transition={{ duration: 1, ease: "easeInOut" }}
      >
        <h1 className="text-primary_text font-amazingSlab text-3xl mt-10 mb-2 font-bold text-center">
          Application
        </h1>
        <p className="text-base font-amazingSlab text-center">
          Please enter your details below to apply:
        </p>
      </motion.div>
      {/** connect form */}
      <form
        className="flex flex-col border border-primary_text relative 
